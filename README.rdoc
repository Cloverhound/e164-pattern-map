...
To create a new site or list go to http://server_ip/sites

To create the corresponding list of numbers go to http://server_ip/numbers

To create see a HTML list of numbers in a list go to http://server_ip/sites/<id>/numbers

To see the actual generated config file for IOS go to http://server_ip/sites/<id>/numbers_ios
